...
module Queue32_UInt64(	// src/main/scala/chisel3/util/Queue.scala:60:7
  ...
  wire [4:0] deq_ptr_next = (&deq_ptr_value) ? 5'h0 : 5'(deq_ptr_value + 5'h1);	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:106:{27,42,84}
  wire [4:0] r_addr = do_deq ? deq_ptr_next : deq_ptr_value;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:106:27, :107:33, src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
    ...
    if (reset) begin	// src/main/scala/chisel3/util/Queue.scala:60:7
      ...
      if (io_flush) begin	// src/main/scala/chisel3/util/Queue.scala:72:14
        ...
        if (do_enq)	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
          enq_ptr_value <= 5'(enq_ptr_value + 5'h1);	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24
        if (do_deq)	// src/main/scala/chisel3/util/ReadyValidIO.scala:48:35
          deq_ptr_value <= 5'(deq_ptr_value + 5'h1);	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:24
      end
  ...
  ram_32x64 ram_ext (	// src/main/scala/chisel3/util/Queue.scala:73:44
  ...
  assign io_count = {full, 5'(enq_ptr_value - deq_ptr_value)};	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Queue.scala:60:7, :79:24, :126:32, :129:62
endmodule
